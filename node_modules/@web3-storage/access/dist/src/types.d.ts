...
import type { Delegation, Fact, Proof, RequestEncoder, ResponseDecoder, ServiceMethod, SigningAuthority, UCAN } from '@ucanto/interface';
import type { IdentityIdentify, IdentityRegister, IdentityValidate } from './capabilities-types.js';
export * from './capabilities-types.js';
export interface ClientCodec extends RequestEncoder, ResponseDecoder {
}
export interface Service {
    identity: {
        validate: ServiceMethod<IdentityValidate, {
            delegation: string;
        } | void, never>;
