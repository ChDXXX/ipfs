...
export interface IdentityRegister extends Capability<'identity/register', `mailto:${string}`> {
    as: DID;
}
export interface IdentityIdentify extends Capability<'identity/identify', DID> {
}
//# sourceMappingURL=capabilities-types.d.ts.map