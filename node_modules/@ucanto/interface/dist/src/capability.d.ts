...
export interface Match<T = unknown, M extends Match = UnknownMatch> extends Selector<M> {
    source: Source[];
    value: T;
    proofs: Delegation[];
...
export interface GroupSelector<M extends Match[] = Match[]> extends Selector<Amplify<M>> {
}
export interface MatchSelector<M extends Match> extends Matcher<M>, Selector<M> {
}
...
export interface CapabilitiesParser<M extends Match[] = Match[]> extends View<Amplify<M>> {
    /**
...
export interface Amplify<Members extends Match[]> extends Match<InferValue<Members>, Amplify<InferMatch<Members>>> {
}
