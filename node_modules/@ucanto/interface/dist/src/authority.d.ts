...
export interface Authority<A extends number = number> extends ArrayBufferView, UCAN.Authority<A> {
    bytes: Uint8Array;
}
export interface SigningAuthority<A extends number = number> extends ArrayBufferView, Identity, Verifier<A>, Signer<A> {
