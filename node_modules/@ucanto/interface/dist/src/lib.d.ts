...
export interface IssuedInvocationView<C extends Capability = Capability> extends IssuedInvocation<C> {
    ...
    execute<T extends InvocationService<C>>(service: ConnectionView<T>): Await<InferServiceInvocationReturn<C, T>>;
}
...
export declare type Result<T, X extends {
    error: true;
}> = (T extends null | undefined ? T : never) | (T & {
    error?: never;
}) | X;
...
export interface ServerOptions extends InboundTransportOptions, ValidatorOptions {
    /**
