...
export interface RequestEncoder {
    encode<I extends Tuple<ServiceInvocation>>(invocations: I, options?: EncodeOptions): Await<HTTPRequest<I>>;
}
export interface RequestDecoder {
    decode<I extends Tuple<ServiceInvocation>>(request: HTTPRequest<I>): Await<InferInvocations<I>>;
}
