...
export interface ProviderOptions extends CanIssue {
    ...
    resolve?: (proof: API.LinkedProof) => API.Await<API.Result<API.Delegation, API.UnavailableProof>>;
    authority: API.AuthorityParser;
}
export interface ProviderContext<A extends API.Ability = API.Ability, R extends API.URI = API.URI, C extends API.Caveats = API.Caveats> {
