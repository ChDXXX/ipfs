 ...
 * for a cryptographic signing algorithm
 */
export interface Signature<T = unknown, A extends number = number> extends ByteView<T> {
    algorithm?: A;
}
/**
...
export interface AsyncVerifier<A extends number> {
    verify<T>(payload: ByteView<T>, signature: Signature<T, A>): PromiseLike<boolean>;
}
/**
 ...
 */
export declare type Await<T> = T | PromiseLike<T>;
